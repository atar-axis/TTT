...
public class StateHelper implements javax.media.ControllerListener {
    ...
    /**
     * Configure the player. This method will block until either the player has been configured or the configure has
     * failed.
     */
    ...
    /**
     * Prefetch the player. This method will block until either the player has been configured or the configure has
     * failed.
     */
    public boolean prefetch() {
        return prefetch(Integer.MAX_VALUE);
    }
    ...
    /**
     * Start the player and play till the end of the media. This method will block until either the player has finished
     * playing the media or the playback has failed at some point.
     */
